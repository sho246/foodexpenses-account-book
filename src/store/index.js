...
const state = {
  ...
  settings: {
    ...
    apiUrl: '',
    authToken: '',
    strIncomeItems: '預け金, 貯金',
    strOutgoItems: '固定費:家賃, 固定費:ネット, 変動費:光熱費(電気), 変動費:光熱費(ガス), 変動費:光熱費(水道), 変動費:食費(スーパー), 変動費:食費(コンビニ), 変動費:食費(ドラッグストア), 変動費:食費(外食・デリバリー), 変動費:食費(水・お米など), 変動費:日用品, 変動費:雑費',
    strTagItems: '共有VISAデビ, 共有現金, れいな立て替え, しょうへい立て替え'
  }
}
